...
export enum RangeLinkExtensionSpecificCodes {
  ...
  DESTINATION_BIND_FAILED = 'DESTINATION_BIND_FAILED',
  DESTINATION_FOCUS_FAILED = 'DESTINATION_FOCUS_FAILED',
  DESTINATION_NOT_AVAILABLE = 'DESTINATION_NOT_AVAILABLE',
  DESTINATION_NOT_BOUND = 'DESTINATION_NOT_BOUND',
  DESTINATION_NOT_IMPLEMENTED = 'DESTINATION_NOT_IMPLEMENTED',
  EMPTY_SELECTION = 'EMPTY_SELECTION',
  FILE_PICKER_EMPTY_ITEMS = 'FILE_PICKER_EMPTY_ITEMS',
  ...
  LOG_CAPTURE_DISABLED = 'LOG_CAPTURE_DISABLED',
  ...
  TERMINAL_PICKER_EMPTY_ITEMS = 'TERMINAL_PICKER_EMPTY_ITEMS',
  TEST_FIXTURE_REGISTRY_DISABLED = 'TEST_FIXTURE_REGISTRY_DISABLED',
  UNEXPECTED_DESTINATION_KIND = 'UNEXPECTED_DESTINATION_KIND',
  UNEXPECTED_ITEM_KIND = 'UNEXPECTED_ITEM_KIND',
  UNEXPECTED_PICKER_OUTCOME = 'UNEXPECTED_PICKER_OUTCOME',
