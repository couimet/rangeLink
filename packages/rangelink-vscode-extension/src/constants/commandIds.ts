...
export const CMD_PASTE_CURRENT_FILE_PATH_ABSOLUTE = 'rangelink.pasteCurrentFilePath';
export const CMD_PASTE_CURRENT_FILE_PATH_RELATIVE = 'rangelink.pasteCurrentFilePathRelative';
export const CMD_PASTE_FILE_PATH_ABSOLUTE = 'rangelink.pasteFilePath';
export const CMD_PASTE_FILE_PATH_RELATIVE = 'rangelink.pasteFilePathRelative';
