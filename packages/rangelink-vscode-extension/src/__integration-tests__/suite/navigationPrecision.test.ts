...
suite('Navigation Precision', () => {
  ...
  // full-line-navigation-001: #L10 selects the full line (col 0 → end of line)
  ...
  // full-line-navigation-002: #L10-L15 selects lines 10 through 15 (anchor at start of line 10, active at end of line 15)
