...
export const messagesEn: Record<MessageCode, string> = {
  ...
  [MessageCode.INFO_NAVIGATION_FILENAME_PICKER_PLACEHOLDER]: 'Select a file to navigate to',
  ...
  [MessageCode.WARN_FILE_PATH_DIRTY_BUFFER]: 'RangeLink: File has unsaved changes. The AI tool may read stale content from disk.',
  ...
  [MessageCode.WARN_LINK_DIRTY_BUFFER]: 'RangeLink: File has unsaved changes. Link may point to wrong position after save.',
