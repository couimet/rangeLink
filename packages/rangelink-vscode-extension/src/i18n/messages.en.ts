...
export const messagesEn: Record<MessageCode, string> = {
  ...
  [MessageCode.INFO_NAVIGATION_INPUT_BOX_PLACEHOLDER]: 'src/magic/RangeLink.ts#L3C14-L15C9',
  ...
  [MessageCode.STATUS_BAR_MENU_ITEM_NAVIGATE_TO_LINK_LABEL]: '$(link-external) Navigate to Link',
