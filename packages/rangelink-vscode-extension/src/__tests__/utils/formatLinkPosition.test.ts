...
describe('formatLinkPosition', () => {
  describe('Single position (start equals end)', () => {
    it('should format single position with line and character', () => {
      const start: LinkPosition = { line: 42, character: 10 };
      const end: LinkPosition = { line: 42, character: 10 };
    ...
    it('should format single position at line 1', () => {
      const start: LinkPosition = { line: 1, character: 1 };
      const end: LinkPosition = { line: 1, character: 1 };
  ...
  describe('Range on different lines', () => {
    it('should format range with both line and character', () => {
      const start: LinkPosition = { line: 10, character: 5 };
      const end: LinkPosition = { line: 20, character: 10 };
    ...
    it('should format range with end character but no start character', () => {
      const start: LinkPosition = { line: 10 };
      const end: LinkPosition = { line: 20, character: 15 };
  ...
  describe('Edge cases', () => {
    it('should format large line numbers', () => {
      const start: LinkPosition = { line: 9999, character: 99 };
      const end: LinkPosition = { line: 10000, character: 1 };
    ...
    it('should handle character 0 (first column)', () => {
      const start: LinkPosition = { line: 10, character: 0 };
      const end: LinkPosition = { line: 10, character: 0 };
