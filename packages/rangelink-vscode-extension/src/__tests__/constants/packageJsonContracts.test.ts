...
describe('package.json contributions', () => {
  ...
  describe('menus', () => {
    ...
    describe('explorer/context', () => {
      ...
      it('explorer.bind for files only', () => {
      ...
      it('explorer.unbind shows when bound and file selected', () => {
