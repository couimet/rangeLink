...
**Generated:** 2025-11-12 03:17:37 UTC
...
- ✓ VSIX file exists: `rangelink-vscode-extension-0.3.0.vsix`
- ✓ CHANGELOG.md has version section: `## [0.3.0]`
- ✓ CHANGELOG.md has reference link: `[0.3.0]: ...`
- ✓ Git tag does not exist: `vscode-extension-v0.3.0`
