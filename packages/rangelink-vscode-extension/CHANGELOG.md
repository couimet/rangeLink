...
- **Status bar bound-state appearance** - The R-M status bar icon now dynamically reflects bind state (#23)
  - Tooltip shows the bound destination name (e.g., `RangeLink — Terminal ("bash")`) when bound, or `RangeLink — no destination bound` when unbound
...
[Unreleased]: https://github.com/couimet/rangelink/compare/vscode-extension-v2.0.0...HEAD
[2.0.0]: https://github.com/couimet/rangelink/compare/vscode-extension-v1.0.0...vscode-extension-v2.0.0
